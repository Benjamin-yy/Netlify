...
$(function () {
    ...
    function echart_1() {
        ...
        var xAxisData = ['2000', '2004', '2008', '2012', '2016', '2020','2024'];
        var legendData = ['望天树', '须弥红豆杉','华盖木'];
        var title = "";//标题
        var serieData = [];
        var metaDate = [
            [500, 520, 550, 620, 780, 1200,1500],
            [6,56,206,506,1506,8006,15006],
            [1000,835, 931,1247, 1887, 2411,3300]
        ]
    ...
    function echart_3() {
        ...
        var xAxisData = ['2000', '2004', '2008', '2012', '2016', '2020','2024'];
        var legendData = ['西双版纳', '高黎贡山','哀牢山'];
        var title = "";//标题
        var serieData = [];
        var metaDate = [
            [3800, 3900, 4000, 4210, 4350, 4500,4825],
            [4500,4700, 4876, 4942, 5000, 5128,5300],
            [1800, 1920, 2058, 2173, 2200, 2322,2500]
        ]
        for (var v = 0; v < legendData.length; v++) {
            var serie = {
                name: legendData[v],
